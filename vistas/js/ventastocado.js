...
$("#tablaVentaServicios tbody").on("click", "button.agregarServicio", function(){
    ...
    // Aca debo corroborar si el servicio se encuentra en el LocalStorage. Si es así, debo eliminarlo.
    ...
    if(serviciosAEliminar != undefined){
        ...
        console.log("unique agregar", unique)
...
$(".formularioVenta").on("click", "button.quitarServicio", function(){
        ...
        ===========================================*/
         ...
         // Si quitarServicio del localStorage todavia no tiene nada
         var lsqs = localStorage.getItem("quitarServicio");

         console.log("lsqs s", unique)
         
         if(lsqs != undefined){
            var ex = JSON.parse(lsqs)
           
            var unique = [...new Set(ex.map(item => item.idServicio))];
            console.log("unique si tiene datos", unique)
            localStorage.setItem("quitarServicio", JSON.stringify(unique));
        ...
        var unique = [...new Set(idQuitarServicio.map(item => item))];
            console.log("unique 418", unique)
        localStorage.setItem("quitarServicio", JSON.stringify(unique));
